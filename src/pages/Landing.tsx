    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h1 variants={fadeUp} custom={1} className="text-5xl lg:text-6xl font-extrabold leading-[1.1] text-foreground">
          ...
          >
            ...
            <img
              src={heroImage}
              alt="ClaimPilot AI Dashboard Preview"
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.h2 variants={fadeUp} custom={0} className="text-3xl font-bold text-foreground mb-4">
