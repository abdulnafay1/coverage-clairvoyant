...
export default function ClaimScorePanel() {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold text-foreground mb-6">Claim Strength Score</h2>
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="flex-1 space-y-4 w-full">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-light text-emerald text-sm font-medium">
              ...
              <div key={b.label} className="rounded-xl border border-border bg-card p-4">
                ...
                {b.value !== null ? (
                  <div className="flex items-end gap-2">
                    ...
                    <div className="flex-1 h-2 rounded-full bg-muted overflow-hidden mb-1.5">
                      <motion.div
