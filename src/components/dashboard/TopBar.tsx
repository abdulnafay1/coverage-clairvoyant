...
export default function TopBar() {
  return (
    <header className="h-16 border-b border-border bg-card/80 backdrop-blur-lg flex items-center justify-between px-8" aria-label="Claim status bar">
      ...
      <div className="flex items-center gap-2 text-sm" role="status" aria-label="Appeal deadline: 12 days remaining">
